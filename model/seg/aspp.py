...
class ASPPModule(nn.Module):
    def __init__(self, inplane, plane, kernel_size, padding, dilation):
        super(ASPPModule, self).__init__()
        self.atrous_conv = nn.Conv2d(inplane, plane, kernel_size, stride=1, padding=padding, dilation=dilation,
                                     bias=False)
