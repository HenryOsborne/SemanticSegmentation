...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        extra = {
            ...
            'STAGE3': {'NUM_MODULES': 3, 'NUM_BRANCHES': 3, 'BLOCK': 'BOTTLENECK', 'NUM_BLOCKS': (2, 2, 2),
                       'NUM_CHANNELS': (18, 36, 72), 'FUSE_METHOD': 'SUM'},
            'STAGE4': {'NUM_MODULES': 2, 'NUM_BRANCHES': 4, 'BLOCK': 'BOTTLENECK', 'NUM_BLOCKS': (2, 2, 2, 2),
        ...
        #     'STAGE3': {'NUM_MODULES': 3, 'NUM_BRANCHES': 3, 'BLOCK': 'BOTTLENECK', 'NUM_BLOCKS': (4, 4, 4),
        #                'NUM_CHANNELS': (48, 96, 192), 'FUSE_METHOD': 'SUM'},
        #     'STAGE4': {'NUM_MODULES': 2, 'NUM_BRANCHES': 4, 'BLOCK': 'BOTTLENECK', 'NUM_BLOCKS': (4, 4, 4, 4),
